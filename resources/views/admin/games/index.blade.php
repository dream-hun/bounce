            ...
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Game">
                    ...
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.game.fields.team_one') }}
                        </th>
                        <th>
                            {{ trans('cruds.game.fields.team_two') }}
                        </th>
                        <th>
                            {{ trans('cruds.game.fields.avenue') }}
                        </th>
                        <th>
                            {{ trans('cruds.game.fields.game_date') }}
                        </th>
                        <th>
                            {{ trans('cruds.game.fields.game_time') }}
                        </th>
                        <th>
                            {{ trans('cruds.game.fields.ticket_url') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
