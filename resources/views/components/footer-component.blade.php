                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">
                            ...
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                    d="M20.5 2H3.5A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h8.25v-7.5H9V11h2.25V9c0-2.25 1.38-3.5 3.5-3.5 1 0 2 .12 2 .12v2.25h-1.38c-1.12 0-1.5.69-1.5 1.38v1.88H16l-.25 2.5H13.5V22h7.75A1.5 1.5 0 0022 20.5V3.5A1.5 1.5 0 0020.5 2Z" />
                            </svg>
                        </a>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">
                            <span class="sr-only">TikTok</span>
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 512 512" id="icons"
